...
st.title("Data Analysis/ Data mining Tool")
...
if file:
    ...
    app.add_app("ASG6. AGNES, DIANA, KMEAN, DBSCAN", asg6.app)
    app.add_app("ASG7. APR, Rules Generation", asg7.app)
    app.add_app("ASG8. Web Crawler, PageRank, HITS", asg8.app)
    # The main app
    app.run(data)
